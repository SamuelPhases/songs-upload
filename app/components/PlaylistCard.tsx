...
const PlaylistCard = ({playlist, updatingProfile}: PlaylistCardProps) => {
  ...
  return (
    <Link href={`/playlist/${playlist?.id}`} className="rounded-lg group relative h-52 lg:h-56 xl:h-60 w-full flex flex-col items-center p-3">
      ...
      <div className="absolute w-full px-3 flex flex-col gap-1 md:gap-2">
        {/* <div className="h-32 md:h-44 lg:lg:h-40 w-[95%] mx-auto bg-gray-700 rounded-lg overflow-hidden shadow-2xl group-hover:shadow-gray-700 group-focus:shadow-gray-700 group-active:shadow-gray-700 relative grid place-content-center"> */}
        ...
        <PlaylistCardInfo owner={playlist?.owner} updatingProfile={updatingProfile} />
      </div>
    </Link>
  )
}
